...
namespace CSPractice1
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //사칙 연산자 = 산술연산자 = Arithmetic Operator
            //+ - * / %
            ...
            Console.WriteLine("Hello" + " " + "World");
            //문자열 인덱스 접근 [ ]
            Console.WriteLine("Hellow World"[4]); //'o'
            //Console.WriteLine("Hellow World"[100]); //예외발생

            //주의
            Console.WriteLine('가' + '힣');
            //문자열연결연산자X 덧셈으로 인식 : 99235
